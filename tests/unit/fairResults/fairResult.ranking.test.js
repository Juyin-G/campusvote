...
// Corren con Jest como el resto de la suite (sin tocar PostgreSQL): no
// importar describe/it de `node:test`, porque Jest no vería ninguna prueba.
//
// Las reglas que dependen de la BD (404, tenant, publicación) se cubren en
// tests/integration/fairResults*.integration.test.js con PostgreSQL real.
