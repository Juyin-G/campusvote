...
const P1 = '12000000-0000-4000-8000-000000000001';
const P4 = '12000000-0000-4000-8000-000000000002';
const P5 = '12000000-0000-4000-8000-000000000003';
const P2 = '12000000-0000-4000-8000-000000000004';
const P3 = '12000000-0000-4000-8000-000000000005';
const CLOSED2_P1 = '52000000-0000-4000-8000-000000000001';

const JURY_A = '42000000-0000-4000-8000-000000000001';
...
describe('FairResults Integration — autorización + ranking + publicación', () => {
  beforeAll(async () => {
    ...
    for (let i = 0; i < 4; i++) await castAnonymousVote({ fairId: fairClosedId, projectId: P2 });
    for (let i = 0; i < 3; i++) await castAnonymousVote({ fairId: fairClosedId, projectId: P1 });
    for (let i = 0; i < 3; i++) await castAnonymousVote({ fairId: fairClosedId, projectId: P4 });
    for (let i = 0; i < 3; i++) await castAnonymousVote({ fairId: fairClosedId, projectId: P5 });
    ...
    await createProject({ id: '32000000-0000-4000-8000-000000000001', fairId: fairForeignId, organizationId: orgB.id, createdById: adminB.id, name: 'Extranjero', status: 'APPROVED' });
    await castAnonymousVote({ fairId: fairForeignId, projectId: '32000000-0000-4000-8000-000000000001' });
