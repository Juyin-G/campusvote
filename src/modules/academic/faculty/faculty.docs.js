 ...
 *   get:
 *     summary: Obtener lista de facultades (paginada)
 *     tags: [Academic]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 *       409:
 *         description: Conflicto - El código o nombre ya existe
 *         content:
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/ErrorResponse'
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 *       409:
 *         description: Conflicto - El nuevo código o nombre ya está en uso
 *         content:
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/ErrorResponse'
