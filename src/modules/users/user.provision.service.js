...
export const provisionAdmin = async (body = {}, actor = {}) => {
  ...
  const newUser = await userRepository.create({
    ...
    // chk_users_scope_admin_only: todo ADMIN tiene alcance (ORG por defecto).
    scopeLevel: 'ORG',
    mustChangePassword: true,
    // La respuesta anuncia must_setup_2fa: sin guardarlo en la BD (por defecto
    // FALSE) el login nunca le pedía configurar el 2FA.
    mustSetup2fa: true,
    isVerified: true,
