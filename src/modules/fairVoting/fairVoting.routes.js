...
// Router aparte: `router` se monta dentro del tenantRouter, que exige sesión,
// y así nadie podía verificar su comprobante sin iniciar sesión.
export const fairVotingPublicRouter = Router();
fairVotingPublicRouter.get(
