 ...
 * Capa HTTP: recibe request, delega a candidateList.service, responde JSON.
 *
 * S4-06 — CRUD de listas candidatas.
 * Rutas anidadas bajo /api/elections/:electionId/candidate-lists,
 * porque una lista no existe fuera de su elección.
 */
