/**
 * Election Controller
 * Capa HTTP: recibe request, delega a election.service, responde JSON.
 *
 * S4-01 — CRUD de elecciones.
 * S4-13 — Endpoint de cambio de estado del workflow.
 */
...
export const listElections = asyncHandler(async (req, res) => {
  const { elections, pagination } = await electionService.listElections(
    req.query
  );
...
/**
 * Actualizar una elección (solo en estado DRAFT)
...
/**
 * Eliminar una elección (solo en estado DRAFT)
