/**
 * Election Rules Controller
 * Capa HTTP: recibe request, delega a electionRules.service, responde JSON.
 *
 * S4-10 — Reglas de la elección: quórum, voto blanco/nulo, 2FA.
 *
 * La relación con la elección es 1:1, así que el recurso es singular:
 * /api/elections/:electionId/rules  (sin :id propio).
 */
...
/**
 * Configurar las reglas de una elección (solo en DRAFT, una sola vez)
...
/**
 * Modificar las reglas de una elección (solo en DRAFT)
 * @route PUT /api/elections/:electionId/rules
 * @access ADMIN, ELECTORAL_COMMISSION
 */
...
/**
 * Eliminar las reglas de una elección (vuelve a los valores por defecto)
