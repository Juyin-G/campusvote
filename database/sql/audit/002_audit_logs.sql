...
-- TABLA: AUDIT LOGS (INMUTABLES Y PROTEGIDOS POR PRIVACIDAD)
...
CREATE TABLE IF NOT EXISTS audit_logs (
    ...
    -- Garantía de secreto del voto: desacopla identidad y red
    -- en el log de emisión
...
CREATE INDEX IF NOT EXISTS idx_audit_logs_election_timestamp
    ON audit_logs (election_id, timestamp DESC);
